...
USART_TypeDef* COM_USART[COMn] = {EVAL_COM1,EVAL_COM3,EVAL_COM6}; 

GPIO_TypeDef* COM_TX_PORT[COMn] = {EVAL_COM1_TX_GPIO_PORT,EVAL_COM3_TX_GPIO_PORT,EVAL_COM6_TX_GPIO_PORT};

GPIO_TypeDef* COM_RX_PORT[COMn] = {EVAL_COM1_RX_GPIO_PORT,EVAL_COM3_RX_GPIO_PORT,EVAL_COM6_RX_GPIO_PORT};

const uint32_t COM_USART_CLK[COMn] = {EVAL_COM1_CLK,EVAL_COM3_CLK,EVAL_COM6_CLK};

const uint32_t COM_TX_PORT_CLK[COMn] = {EVAL_COM1_TX_GPIO_CLK,EVAL_COM3_TX_GPIO_CLK,EVAL_COM6_TX_GPIO_CLK};

const uint32_t COM_RX_PORT_CLK[COMn] = {EVAL_COM1_RX_GPIO_CLK,EVAL_COM3_RX_GPIO_CLK,EVAL_COM6_RX_GPIO_CLK};

const uint16_t COM_TX_PIN[COMn] = {EVAL_COM1_TX_PIN,EVAL_COM3_TX_PIN,EVAL_COM6_TX_PIN};

const uint16_t COM_RX_PIN[COMn] = {EVAL_COM1_RX_PIN,EVAL_COM3_RX_PIN,EVAL_COM6_RX_PIN};

const uint16_t COM_TX_PIN_SOURCE[COMn] = {EVAL_COM1_TX_SOURCE,EVAL_COM3_TX_SOURCE,EVAL_COM6_TX_SOURCE};

const uint16_t COM_RX_PIN_SOURCE[COMn] = {EVAL_COM1_RX_SOURCE,EVAL_COM3_RX_SOURCE,EVAL_COM6_RX_SOURCE};

const uint16_t COM_TX_AF[COMn] = {EVAL_COM1_TX_AF,EVAL_COM3_TX_AF,EVAL_COM6_TX_AF};

const uint16_t COM_RX_AF[COMn] = {EVAL_COM1_RX_AF,EVAL_COM3_RX_AF,EVAL_COM6_RX_AF};


const uint16_t EVAL_IRQn[COMn] = {EVAL_COM1_IRQn,EVAL_COM3_IRQn,EVAL_COM6_IRQn};
