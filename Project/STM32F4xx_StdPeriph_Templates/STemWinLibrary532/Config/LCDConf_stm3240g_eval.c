...
#define GUI_TOUCH_AD_RIGHT 	 3760
#define GUI_TOUCH_AD_TOP 	 435
...
void LCD_X_Config(void) {
  ...
  LCD_SetVSizeEx(0, VXSIZE_PHYS, VYSIZE_PHYS);
   	...
   	GUI_TOUCH_Calibrate(GUI_COORD_X, 0, 240, GUI_TOUCH_AD_LEFT,  GUI_TOUCH_AD_RIGHT);
	GUI_TOUCH_Calibrate(GUI_COORD_Y, 0, 320, GUI_TOUCH_AD_TOP,  GUI_TOUCH_AD_BOTTOM);
