...
#define SWIM_RST_LOW(pswim) 	(GPIO_WriteBit(((SWIM_HANDLE *)pswim)->swim_rst_port, ((SWIM_HANDLE *)pswim)->swim_rst_pin, Bit_RESET))

#define SWIM_HIGH(pswim)        (GPIO_WriteBit(((SWIM_HANDLE *)pswim)->swim_port, ((SWIM_HANDLE *)pswim)->swim_pin, Bit_SET))			 
#define SWIM_LOW(pswim) 	(GPIO_WriteBit(((SWIM_HANDLE *)pswim)->swim_port, ((SWIM_HANDLE *)pswim)->swim_pin, Bit_RESET))
