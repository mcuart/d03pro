...
USBD_DEVICE USR_desc_msc = {
  USBD_USR_DeviceDescriptor_msc,
  USBD_USR_LangIDStrDescriptor_msc,
  USBD_USR_ManufacturerStrDescriptor_msc,
  USBD_USR_ProductStrDescriptor_msc,
  USBD_USR_SerialStrDescriptor_msc,
  USBD_USR_ConfigStrDescriptor_msc,
  USBD_USR_InterfaceStrDescriptor_msc,
};
...
#endif                          /* USB_OTG_HS_INTERNAL_DMA_ENABLED */
/* USB Standard Device Descriptor */
__ALIGN_BEGIN uint8_t USBD_DeviceQualifierDesc_msc[USB_LEN_DEV_QUALIFIER_DESC]
  __ALIGN_END = {
...
*/
uint8_t *USBD_USR_DeviceDescriptor_msc(uint8_t speed, uint16_t * length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *USBD_USR_LangIDStrDescriptor_msc(uint8_t speed, uint16_t * length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *USBD_USR_ProductStrDescriptor_msc(uint8_t speed, uint16_t * length)
{
  if (speed == 0)
  {
    USBD_GetString((uint8_t *) (uint8_t *) USBD_PRODUCT_HS_STRING, USBD_StrDesc_msc,
                   length);
  }
  else
  {
    USBD_GetString((uint8_t *) (uint8_t *) USBD_PRODUCT_FS_STRING, USBD_StrDesc_msc,
                   length);
  }
...
* @retval pointer to descriptor buffer
*/
uint8_t *USBD_USR_ManufacturerStrDescriptor_msc(uint8_t speed, uint16_t * length)
{
  USBD_GetString((uint8_t *) (uint8_t *) USBD_MANUFACTURER_STRING, USBD_StrDesc_msc,
                 length);
  return USBD_StrDesc_msc;
}
...
* @retval pointer to descriptor buffer
*/
uint8_t *USBD_USR_SerialStrDescriptor_msc(uint8_t speed, uint16_t * length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *USBD_USR_ConfigStrDescriptor_msc(uint8_t speed, uint16_t * length)
{
  if (speed == USB_OTG_SPEED_HIGH)
  {
    USBD_GetString((uint8_t *) (uint8_t *) USBD_CONFIGURATION_HS_STRING,
                   USBD_StrDesc_msc, length);
  }
  else
  {
...
* @retval pointer to descriptor buffer
*/
uint8_t *USBD_USR_InterfaceStrDescriptor_msc(uint8_t speed, uint16_t * length)
{
  if (speed == 0)
  {
